...
Whichever agent you run, the file is text in a prompt, not a parsed config. Claude Code's documentation says so plainly: **"no guarantee of strict compliance, especially for vague or conflicting instructions"**. The file above has both problems.
